...
if (_name_ == '_main_'):
    ...
    node9 = NodeConfig(name='node9', port_bindings={'8081': '8090', '14265': '14209'})
    node10 = NodeConfig(name='node10', port_bindings={'8081': '8091', '14265': '14210'})
    ...
    iota = IotaBasic(exp=exp, prefix='iota1', conf_nodes=[node0, node1, node2, node3, node4, node5, node6, node7, node8, node9, node10])
